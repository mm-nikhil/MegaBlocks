...
This run times the full Nano-compatible adapter boundary. For MegaBlocks rows,
the timed call includes layout conversion, router projection, full router
softmax, top-k, selected-logit gate softmax, aux-loss setup, expert
dispatch/compute/combine, and output layout conversion.
